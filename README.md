...
PFAdmin is Portfolio management system built on **Next.js and Tailwind CSS** providing developers with everything they need to manage portfolio.

PFAdmin utilizes the powerful features of **Next.js 13** and common features of Next.js such as server-side rendering (SSR), static site generation (SSG), and seamless API route integration. Combined with the advancements of **React 18** and the robustness of **TypeScript**, TailAdmin is the perfect solution to help get your project up and running quickly.
